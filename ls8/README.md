...
- Make a list of files here.
  - ls8.py
    - Where we will specify what instructions to run
  - cpu.py
    - A list of what those instructions will execute
- Write a short 3-10-word description of what each file does.
- Note what has been implemented, and what hasn't.
  - `def__init__` - constructs a base cpu // [ ] completed
  - `def load` - Loads a program into memory, currently hardcoded // [ ]completed
  - `def alu` - Arithmetic Logic Unit, does math // [ ] completed
  - `def trace` - Prints out cpu state // [ ] completed
  - `def run` - runs the CPU // [ ] completed
